...
export const arthera = {
  ...
  name: 'Arthera',
  network: 'Arthera',
  nativeCurrency: { name: 'arthera', symbol: 'ART', decimals: 18 },
  rpcUrls: {
  ...
  blockExplorers: {
    default: { name: 'Artherscan', url: 'https://explorer.arthera.net' },
  },
  // contracts: {
  //   ensRegistry: {
...
export const artheraTest = {
  id: 10243,
  name: 'ArtheraTest',
  network: 'ArtheraTest',
  nativeCurrency: { name: 'artheraTest', symbol: 'ART', decimals: 18 },
  rpcUrls: {
    default: { http: ['https://rpc.arthera.net'] },
    public: {
      http: ['https://rpc.arthera.net'],
...
export const { chains, provider, webSocketProvider } = configureChains(
  [mainnet, polygon, optimism, avalanche, avalancheFuji, celo, sepolia, arthera, artheraTest],
  [
