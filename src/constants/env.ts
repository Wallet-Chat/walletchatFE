...
export const REACT_APP_DEFAULT_COMMUNITY = import.meta.env.VITE_REACT_APP_DEFAULT_COMMUNITY
export const REACT_APP_SUPPORT_WALLET = import.meta.env.VITE_REACT_APP_SUPPORT_WALLET
export const REACT_APP_SUPPORT_HEADER = import.meta.env.VITE_REACT_APP_SUPPORT_HEADER
